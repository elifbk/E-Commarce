...
export function addToCart(event, products) {
  ...
  //* products dizisi içerisinden id'sine ulaştığımız ürünü bulabilmek için find methodunu kullandık.
  ...
  if (product) {
    ...
    //* Sepette daha önceden bu ürün eklenmişse if çalışacak.
    if (exitingItem) {
...
function removeFromCart(event) {
  ...
  const productID = parseInt(event.target.dataset.id);
  //* Tıkladığım elemanı sepetten kaldırır.
